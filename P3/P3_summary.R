...
summary_tab <- tabPanel(
  ...
  p("Rates of employment after graduation matter much to incoming students who seeks a secure path to their jobs after college. With our dataset, all ages, we have found that certain major catagories do have much higher rates of employment after graduation, the top three being health, education and agriculture & natural resource. 
  ...
  h2("Major catagories"),
  p("There are alot of majors within the egeneering catagory, of 26 engineering majors within the proven data set majors_list"),
  h2("Majors and Gender"),
  p("Gender diversity within various majors were also topic we investigated with our data visualization, and we have come to the conlcusion that engineering is the STEM major category with the lowest share of women, while health has the highest share of women.
