...
source("https://raw.githubusercontent.com/info201a-au2022/project-group-4-section-ae/main/P2/B2-summary.R")
...
### Dynamic Paragraph
We determined the median earnings of full-time, year-round workers of those in the `women-stem.csv` file. This data was evaluated for the purpose of determining what salaries women earned. The max median earning was `r summary_info_max`
